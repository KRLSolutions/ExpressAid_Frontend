...
// Animated Health Tracking Illustration
const AnimatedHealthTrackingIllustration = ({ animationProgress }: { animationProgress: Animated.Value }) => {
  const hospitalScale = animationProgress.interpolate({
    inputRange: [0, 0.3, 1],
    outputRange: [0.8, 1.1, 1],
  });
  
  const deviceTranslateX = animationProgress.interpolate({
    inputRange: [0, 0.5, 1],
    outputRange: [-50, 0, 0],
  });
  
  const floatingElementsOpacity = animationProgress.interpolate({
    inputRange: [0, 0.7, 1],
    outputRange: [0, 1, 1],
  });
  ...
  return (
    <Svg width={width * 0.9} height={height * 0.4} viewBox="0 0 400 240">
      ...
      {/* Animated Hospital Building */}
      <Animated.View style={{ transform: [{ scale: hospitalScale }] }}>
      ...
      {/* Animated Health monitoring devices */}
      <Animated.View style={{ transform: [{ translateX: deviceTranslateX }] }}>
      ...
      <Animated.View style={{ opacity: floatingElementsOpacity }}>
...
// Animated Quick Nurse Arrival Illustration
const AnimatedQuickNurseArrivalIllustration = ({ animationProgress }: { animationProgress: Animated.Value }) => {
  const clockRotation = animationProgress.interpolate({
    inputRange: [0, 0.4, 1],
    outputRange: ['0deg', '360deg', '360deg'],
  });
  
  const nurseTranslateX = animationProgress.interpolate({
    inputRange: [0, 0.6, 1],
    outputRange: [100, 0, 0],
  });
  
  const speedLinesOpacity = animationProgress.interpolate({
    inputRange: [0, 0.5, 0.8, 1],
    outputRange: [0, 1, 0.5, 0.3],
  });
  ...
  return (
    <View style={{ width: width * 0.9, height: height * 0.4 }}>
      ...
      >
        <View style={{ width: 120, height: 120, borderRadius: 60, borderWidth: 5, borderColor: '#2563eb', opacity: 0.3 }} />
      </Animated.View>
      ...
      <Animated.View 
        style={{
          ...
          top: 60,
          right: 60,
          transform: [{ translateX: nurseTranslateX }],
        }}
      >
        <View style={{ width: 50, height: 50, backgroundColor: '#10b981', borderRadius: 25, opacity: 0.8 }} />
      </Animated.View>
      ...
      >
        <View style={{ width: 40, height: 2, backgroundColor: '#f59e0b', marginBottom: 5 }} />
        <View style={{ width: 30, height: 2, backgroundColor: '#f59e0b', marginBottom: 5 }} />
...
// Animated Nurse Care Illustration
const AnimatedNurseCareIllustration = ({ animationProgress }: { animationProgress: Animated.Value }) => {
  const nurseScale = animationProgress.interpolate({
    inputRange: [0, 0.3, 1],
    outputRange: [0.7, 1.1, 1],
  });
  
  const vitalsTranslateY = animationProgress.interpolate({
    inputRange: [0, 0.5, 1],
    outputRange: [30, 0, 0],
  });
  
  const heartBeatScale = animationProgress.interpolate({
    ...
    <View style={{ width: width * 0.9, height: height * 0.4 }}>
      ...
      <Animated.View 
        style={{
          ...
          top: 80,
          left: 120,
          transform: [{ scale: nurseScale }],
        }}
      >
        <View style={{ width: 80, height: 60, backgroundColor: '#2563eb', borderRadius: 8, opacity: 0.3 }} />
      </Animated.View>
      ...
      <Animated.View 
        style={{
          ...
          top: 100,
          right: 80,
          transform: [{ translateY: vitalsTranslateY }],
        }}
      >
        <View style={{ width: 60, height: 80, backgroundColor: '#10b981', borderRadius: 6, opacity: 0.3 }} />
      </Animated.View>
      ...
      >
        <View style={{ width: 40, height: 20, backgroundColor: '#10b981', borderRadius: 10, opacity: 0.5 }} />
      </Animated.View>
    </View>
  );
};

// Animated Affordable Care Illustration
const AnimatedAffordableCareIllustration = ({ animationProgress }: { animationProgress: Animated.Value }) => {
  const priceTagScale = animationProgress.interpolate({
    inputRange: [0, 0.3, 1],
    outputRange: [0.8, 1.2, 1],
  });
  
  const chartBarsScale = animationProgress.interpolate({
    inputRange: [0, 0.5, 1],
    outputRange: [0, 1, 1],
  });
  
  const lightningRotation = animationProgress.interpolate({
    inputRange: [0, 0.7, 1],
    outputRange: ['0deg', '360deg', '360deg'],
  });
    ...
    <View style={{ width: width * 0.9, height: height * 0.4 }}>
      ...
      <Animated.View 
        style={{
          ...
          top: 80,
          left: 150,
          transform: [{ scale: priceTagScale }],
        }}
      >
        <View style={{ width: 100, height: 80, backgroundColor: '#10b981', borderRadius: 8, opacity: 0.3 }} />
      </Animated.View>
      ...
      <Animated.View 
        style={{
          ...
          top: 60,
          right: 80,
          transform: [{ scale: chartBarsScale }],
        }}
      >
        <View style={{ width: 80, height: 80, backgroundColor: '#f59e0b', borderRadius: 6, opacity: 0.3 }} />
      </Animated.View>
      ...
      <Animated.View 
        style={{
          ...
          top: 70,
          left: 70,
          transform: [{ rotate: lightningRotation }],
        }}
      >
        <View style={{ width: 60, height: 60, backgroundColor: '#f59e0b', borderRadius: 30, opacity: 0.3 }} />
      </Animated.View>
    </View>
  );
};

// Animated App Features Illustration
const AnimatedAppFeaturesIllustration = ({ animationProgress }: { animationProgress: Animated.Value }) => {
  const clockRotation = animationProgress.interpolate({
    inputRange: [0, 0.4, 1],
    outputRange: ['0deg', '360deg', '360deg'],
  });
  
  const supportIconsScale = animationProgress.interpolate({
    inputRange: [0, 0.6, 1],
    outputRange: [0, 1.2, 1],
  });
  
  const emergencyPulse = animationProgress.interpolate({
    inputRange: [0, 0.5, 0.7, 1],
    outputRange: [1, 1.3, 1, 1.2],
  });
  ...
  return (
    <View style={{ width: width * 0.9, height: height * 0.4 }}>
      ...
      >
        <View style={{ width: 120, height: 120, borderRadius: 60, borderWidth: 5, borderColor: '#f59e0b', opacity: 0.3 }} />
      </Animated.View>
      ...
      <Animated.View 
        style={{
          ...
          top: 75,
          left: 75,
          transform: [{ scale: supportIconsScale }],
        }}
      >
        <View style={{ width: 50, height: 50, backgroundColor: '#ef4444', borderRadius: 25, opacity: 0.3 }} />
      </Animated.View>
      ...
      >
        <View style={{ width: 40, height: 40, backgroundColor: '#ef4444', borderRadius: 20, opacity: 0.3 }} />
      </Animated.View>
      ...
      >
        <View style={{ width: 36, height: 36, backgroundColor: '#2563eb', borderRadius: 18, opacity: 0.3 }} />
      </Animated.View>
      ...
      >
        <View style={{ width: 44, height: 44, backgroundColor: '#2563eb', borderRadius: 22, opacity: 0.3 }} />
      </Animated.View>
      ...
      >
        <View style={{ width: 50, height: 50, backgroundColor: '#ef4444', borderRadius: 25, opacity: 0.2 }} />
      </Animated.View>
    </View>
  );
};
...
const slides = [
  {
    illustration: AnimatedQuickNurseArrivalIllustration,
  ...
  {
    illustration: AnimatedNurseCareIllustration,
  ...
  {
    illustration: AnimatedAffordableCareIllustration,
    title: 'Very Cheap &\nEfficient',
  ...
  {
    illustration: AnimatedAppFeaturesIllustration,
    ...
    >
      ...
      <ScrollView style={styles.slide} contentContainerStyle={styles.slideContent}>
        ...
        <View style={styles.illustrationContainer}>
          <currentSlide.illustration animationProgress={illustrationAnim} />
        </View>
